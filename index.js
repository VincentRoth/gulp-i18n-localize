...
module.exports = function(options) {
  ...
  try {
    ...
    log.warn('gulp-i18n-localize: locale directory not found');
  ...
  return through.obj(function(file, enc, cb) {
    ...
    try {
      ...
      errors.forEach(function(error) {
        log.warn('gulp-i18n-localize: ' + error.join(' '));
    ...
    log.warn('gulp-i18n-localize: ' + localizationMatchCount + ' translations found');
    cb();
  });
};
